        ...
        if (rdBtnIterative.isSelected() == false && rdBtnRecursive.isSelected() == false) {
            ...
            if (serie >= 4500) {
                ...
                for (int i = 0; i <= serie; i++) {
                    txtAreaResults.appendText("Fibonacci Serie " + "(" + i + ") = " + FiboMethods.serieFiboIterativa(i) + "\n");
                }
            ...
            if (serie >= 40) {
                ...
                txtAreaResults.setText("\nRecursive Method \n\n");
                for (int i = 0; i <= serie; i++) {
                    txtAreaResults.appendText("Fibonacci Serie " + "(" + i + ") = " + FiboMethods.serieFiboRecursiva(i) + "\n");
                }
                progressBar.setProgress(serie);
            }
