...
public class FiboMethods {
    ...
    /**
     * VERSION A : ALGORITMO ITERATIVO TIPICO hace una suma y tres asignaciones. Por
     * lo tanto su complejidad temporal es O(1), porque ejecuta un número constante
     * de operaciones. En general, todo programa que ejecute un número constante de
     * operaciones tiene complejidad temporal O(1) Finalmente la complejidad del
     * metodo es O(n) porque ejecuta un número de operaciones que siempre esta por
     * debajo de una constante multiplicada por n
     *
